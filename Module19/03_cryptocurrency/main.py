...
data['ETH']['total_out'] = data['tokens'][0].pop('total_out', 123)

# Внутри "sec_token_info" изменить название ключа “price” на “total_price”.
# data['tokens'][0]['sec_token_info']['total_price'] = data['tokens'][0]['sec_token_info'].pop('price', 9999)
data['tokens'][1]['sec_token_info']['total_price'] = data['tokens'][1]['sec_token_info'].pop('price',123658)
print(data)